...
<head>
    ...
    <link rel="stylesheet" type="text/css" href='/biblioteca/app/views/layouts/form.css' media="screen" />
</head>
<body>
    <?php $basePath = '/biblioteca/public'; ?>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-link <?php echo ($page ?? '') === 'cadastro' ? 'active' : ''; ?>" href="<?php echo $basePath; ?>/cadastro">Cadastro</a>
